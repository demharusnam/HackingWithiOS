...
struct ProspectsView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationBarItems(leading: Button(action: { self.isShowingSort = true }) {
            ...
            .actionSheet(isPresented: $isShowingSort) {
                ActionSheet(title: Text("Sort"), message: Text("Change sort type."), buttons: [
                    .default(Text("Recent"), action: { self.sortType = .recent }),
